...
const config: Config = {
  ...
  theme: {
    extend: {
       ...
       * ======================================== */
      boxShadow: {
        'primary': '0 4px 14px 0 rgba(102, 126, 234, 0.3)',
        'secondary': '0 4px 14px 0 rgba(118, 75, 162, 0.3)',
        'success': '0 4px 14px 0 rgba(16, 185, 129, 0.3)',
        'warning': '0 4px 14px 0 rgba(245, 158, 11, 0.3)',
        'destructive': '0 4px 14px 0 rgba(239, 68, 68, 0.3)',
      ...
      backgroundImage: {
        ...
        'gradient-dark': 'linear-gradient(135deg, hsl(222.2, 84%, 4.9%) 0%, hsl(217.2, 32.6%, 17.5%) 100%)',
        'gradient-light': 'linear-gradient(135deg, hsl(0, 0%, 100%) 0%, hsl(210, 40%, 96.1%) 100%)',
