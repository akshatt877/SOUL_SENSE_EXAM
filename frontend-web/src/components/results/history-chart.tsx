...
const CustomTooltip = ({ active, payload, label }: any) => {
    if (active && payload && payload.length) {
        return (
            <div className="backdrop-blur-xl bg-slate-900/90 border border-white/10 p-4 rounded-xl shadow-2xl">
...
export const HistoryChart: React.FC<HistoryChartProps> = ({
    ...
    if (!results || results.length === 0) {
        return (
            <Card className="w-full h-[400px] flex items-center justify-center backdrop-blur-xl bg-white/60 dark:bg-slate-900/60 border-slate-200 dark:border-white/5 shadow-sm rounded-2xl">
    ...
    return (
        <Card className="w-full backdrop-blur-xl bg-white/60 dark:bg-slate-900/60 border-slate-200 dark:border-white/5 shadow-sm hover:shadow-md transition-all rounded-2xl overflow-hidden">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <CardDescription className="text-sm text-slate-500 font-medium">
                            Tracking your progress over {timeRange === 'all' ? 'the entire period' : `the last ${timeRange}`}
                        </CardDescription>
                    </div>
